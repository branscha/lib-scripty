...
{
    public static enum SysCmdType {gc, mem};

    private SysCmdType type;

    public SysCmd(SysCmdType aType)
    {
        type = aType;
    }
    ...
    {
        aReg.registerCommand("sys-gc", new SysCmd(SysCmdType.gc));
        aReg.registerCommand("sys-mem", new SysCmd(SysCmdType.mem));
    }
